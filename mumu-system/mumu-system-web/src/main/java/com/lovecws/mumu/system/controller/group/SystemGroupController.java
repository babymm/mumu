package com.lovecws.mumu.system.controller.group;
...
public class SystemGroupController {
	...
	public ResponseEntity saveSysGroup(int orgId,String groupName,String remark,String motto,String groupHonors){
	...
	public ResponseEntity updateSysGroup(int groupId,int orgId,String groupName,String remark,String motto,String groupHonors){
		List<SysGroup> groups=groupService.querySysGroupByCondition(null,groupName);
